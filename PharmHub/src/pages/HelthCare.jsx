...
const HealthCare = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-5">
      ...
      <h2 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-blue-600 py-4 px-8 hover:from-blue-600 hover:to-green-600 transition-all duration-500">
      Your Skin, Your Story</h2>
        <button
          className="text-blue-700 font-bold cursor-pointer"
          onClick={() => navigate("/healthcare-products")}
        >
          View All
        </button>
      </div>
